...
```{r}
airbnbSeattleTrain<- read_csv("AirbnbSeattleTrain.csv")
airbnbSeattleTest <- read_csv("AirbnbSeattleTest.csv")
```
...
```{r}
logModHbr <- glm(high_booking_rate~ availability_365 + bathrooms + bed_type + bedrooms + bed_type + price +
